...
# Set up device Camera's
	...
	# Tyrell commandes 2
	xterm -e ssh cohrint@tyrell_corp 'roslaunch ~/cops_and_robots/launch/vicon_sys.launch' &
	xterm -e ssh cohrint@tyrell_corp 'rosservice call /vicon_bridge/calibrate_segment deckard deckard 0 100' &
	...
	# Tyrell commandes 3
	xterm -e ssh cohrint@tyrell_corp 'roslaunch turtlebot_rviz_launchers view_navigation.launch' &
	xterm -e ssh cohrint@tyrell_corp 'roslaunch turtlebot_teleop keyboard_teleop.launch' &
